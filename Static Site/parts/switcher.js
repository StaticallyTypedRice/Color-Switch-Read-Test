...
function startSwitcher() {
	...
	// Uploads Data to the server (Disabled for static site)
	/*
    ...
    var uploadData = {
    	"name": uploadName,
    	"test_group_order": uploadSwitchFreqOrder,
    	"comments": $("#trial-comments").val(),
    	"control": testText[0],
    	"test_group_1": testText[1],
    	"test_group_2": testText[2],
    	"test_group_3": testText[3],
    	"test_group_4": testText[4],
    	"test_group_5": testText[5],
    };
	...
	*/
	...
	// Prints the order of the test groups onto the console
	var switchFreqOrder = "";
	for (var i = 0; i < 6; i++) {
		switchFreqOrder += "[" + switchFreq[i][0] + "], ";
	}
	console.log(switchFreqOrder);
